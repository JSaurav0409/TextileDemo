...
const CompanyHistory = () => {
  ...
  useEffect(() => {
    ...
    // 2. PRELOAD ALL TIMELINE IMAGES
    // This starts downloading timeline images in the background
    // so they are ready before the user even hovers.
  ...
  // Handle stage change with a tiny fade-out/in feel
  ...
  return (
    <div className="bg-[#0e1012] text-white overflow-hidden">
      ...
      <section className="relative h-screen flex flex-col justify-center items-center px-6">
        <div className="absolute inset-0 z-0 bg-[#060708]">
          {" "}
          {/* Fallback dark color */}
          <img
            src={HistoryImage}
            alt="History Background"
            // Optimization: Load this immediately as it's the first thing users see
            loading="eager"
            fetchpriority="high"
        ...
        <div className="flex flex-col lg:flex-row gap-20">
          ...
          <div className="lg:w-1/3" data-aos="fade-right">
            ...
            <div className="space-y-10">
              {historyEvents.map((event, index) => (
                <button
                  key={event.year}
                  onMouseEnter={() => handleStageChange(index)}
          ...
          <div className="lg:w-2/3 relative min-h-[500px]" data-aos="fade-left">
            <div className="relative group overflow-hidden bg-white/5">
              <div className="absolute -top-6 -left-6 w-32 h-32 border-t border-l border-primary/50 z-20" />
              ...
              {/* Optional Spinner/Loader for Timeline Images */}
              {isImgLoading && (
            ...
            <div className="mt-10 max-w-xl">
              ...
              <p className="text-2xl font-serif leading-relaxed italic text-slate-300 transition-opacity duration-500">
